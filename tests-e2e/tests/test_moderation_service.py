...
class TestModerationService:
    ...
    def test_get_pending_products(self, infrastructure_ready, moderator, product_pending):
        resp = requests.get(
            f"{BASE}/products",
    ...
    def test_get_pending_product_by_id(self, infrastructure_ready, moderator, product_pending):
        resp = requests.get(
    ...
    def test_approve_product(self, infrastructure_ready, moderator, product_pending):
        resp = requests.post(
    ...
    def test_reject_product(self, infrastructure_ready, moderator, product_pending):
    ...
    def test_bulk_moderate(self, infrastructure_ready, moderator, db_product, seller, shop):
        ids = [
    ...
    def test_moderation_history_by_moderator(self, infrastructure_ready, moderator):
        resp = requests.get(
            f"{BASE}/history",
            params={"moderatorId": moderator},
        )
    ...
    def test_product_moderation_history(self, infrastructure_ready, product_pending):
